...
public class Help implements Command {
    ...
    public void action(String[] args, MessageReceivedEvent event) {
        ...
        if(message.equals("!help")){
            event.getTextChannel().sendMessage(event.getAuthor().getAsMention() + " - You have not specified the command you want help with! Please type !help [command]");
